...
{
    public abstract class PointOfSalesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PointOfSalesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PointOfSalesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PointOfSalesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PointOfSalesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PointOfSalesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PointOfSalesDbContext, Task<T>> func)
        {
            T result;
